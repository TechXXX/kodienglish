...
default_path = 'plugin://plugin.video.fenlight.kodienglish?mode=navigator.main&full_list=true'
...
class MenuEditor:
	...
	def _get_menu_item(self, path):
		return dict(parse_qsl(path.replace('plugin://plugin.video.fenlight.kodienglish/?','')))
