...
class Navigator:
	...
	def changelog_utils(self):
		fenlight_clogpath = tp('special://home/addons/plugin.video.fenlight.kodienglish/resources/text/changelog.txt')
	...
	def tips(self):
		tips_location = 'special://home/addons/plugin.video.fenlight.kodienglish/resources/text/tips'
