# Arctic Fuse 3 KodiEnglish Notes

This KodiEnglish skin fork is kept in lockstep with:

- `/Users/kalter/Documents/CODEX/kodirepo/skin.dutchtech.fuse.3`

The KodiEnglish copy is not a separate design branch. Sync the DutchTech skin
tree first, then reapply only the KodiEnglish-specific identity and route
targets:
...
does not ship stale path names or outdated fork descriptions.
