...
Read the repository-level `KODI_SETUP_KIT_HANDOVER.md` and the main repo
handover for the detailed architecture, Vercel contract, publishing flow,
live-testing paths, and troubleshooting notes.
