...
REPO_SUMMARY = "Repository for Kodi English add-ons."
REPO_DESCRIPTION = (
    "Install this repository to receive Kodi English add-on updates "
...
def reset_generated_outputs(root_dir: Path, repo_version: str) -> None:
    for path in root_dir.glob(f"{REPO_ADDON_ID}-*.zip"):
