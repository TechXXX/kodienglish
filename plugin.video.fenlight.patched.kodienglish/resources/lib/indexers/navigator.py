...
class Navigator:
	def __init__(self, params):
		...
		self.category_name = self.params_get('name', 'Fen Light Patched')
	...
	def search(self):
		...
		self.add({'mode': 'navigator.search_history', 'action': 'ai_search', 'name': 'Search History AI Search'}, 'AI Search', 'search')
	...
	def changelog_utils(self):
		fenlight_clogpath = tp('special://home/addons/plugin.video.fenlight.patched.kodienglish/resources/text/changelog.txt')
	...
	def tips(self):
		tips_location = 'special://home/addons/plugin.video.fenlight.patched.kodienglish/resources/text/tips'
